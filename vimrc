...
"              |_|
"
"  This is the personal vimrc file of Daniel Altiparmak


" =============== Neobundle Initialization ===============
" This loads all the plugins specified in ~/.vim/neobundles.vim
" Use nebundle plugin to manage all other plugins
...
" ================ Custom Settings ========================
so ~/.daltiparmak/vim/settings.vim
